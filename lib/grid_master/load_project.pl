...
edit_files:-
	edit(grid_master_root(load_project))
	,edit(grid_master_root(grid_master_configuration))
	,edit(grid_master_src(map))
	,edit(grid_master_src(action_generator))
	,edit(grid_master_src(map_display))
	.
:-edit_files.
