:-module(learning_rate_configuration, [copy_plotting_scripts/1
                                      ,logging_directory/1
                                      ,plotting_directory/1
                                      ,r_data_file/1
                                      ,learning_rate_time_limit/1
                                      ]).
...
%       generated by learning_rate.pl. This option determines whether
...
%
%logging_directory('output/mlj_2020/learning_rate/proportional_samples/').
%logging_directory('output/mlj_2020/learning_rate/integer_samples/').
%logging_directory('output/mtg_fragment/test_2/').
%logging_directory('output/testing/kin/test_7/').
logging_directory('output/testing/').
...
%
%plotting_directory('output/mlj_2020/learning_rate/proportional_samples/').
%plotting_directory('output/mlj_2020/learning_rate/integer_samples/').
%plotting_directory('output/mtg_fragment/test_2/').
%plotting_directory('output/testing/kin/test_7/').
plotting_directory('output/testing/').
...
%!	learning_rate_time_limit(?Limit) is semidet.
%
%	Time Limit after which a learning attempt will fail.
%
learning_rate_time_limit(300).
